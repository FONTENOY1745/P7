...
CREATE TABLE `users` (
  ...
  `imageUrl` varchar(255) DEFAULT 'Ma photo',
  `job` varchar(50) DEFAULT 'Mon poste',
...
INSERT INTO `users` VALUES (1,'Admin','Admin','nqzva@tebhcbznavn.se','$2b$10$d8aEJ775Ihq0pOuycEUjeu0f9A22RTGTABLi7dyhTlVNtDzpPZwd.','Ma photo','Mon poste',1,'2022-08-02 15:53:46','2022-08-02 15:53:46');
...
-- Dump completed on 2022-08-02 17:55:04
